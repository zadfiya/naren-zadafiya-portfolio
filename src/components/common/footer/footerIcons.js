...
function FooterIcons() {
  return (
    ...
    >
      <Text tag="a" padding="5px" href="https://www.linkedin.com/in/naren-zadafiya/" target="_blank" rel="noopener noreferrer" title="Linkedin" color="fonts.main">
      ...
      <Text tag="a" padding="5px" href="https://github.com/zadfiya" target="_blank" rel="noopener noreferrer" title="Github" color="fonts.main">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
